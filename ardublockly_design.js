...
Ardublockly.designJsInit = function() {
  ...
  Ardublockly.sketchNameSet('Nom de fichier');
};
...
Ardublockly.bindDesignEventListeners = function() {
  ...
  /*Supprimé par Driss car le panneau XML a été retiré de la page Index
...
Ardublockly.arduinoIdeOutput = function(bodyEl) {
  /* Supprimer par Driss car j'ai retiré le volet IDE Output content (en bas de page) dans index.html
