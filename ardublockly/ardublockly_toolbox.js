...
'<xml>' +
'  <sep></sep>' +
'  <category id="catCommun" name="commun">' +
...
'	<block type="controls_repeat_indefinitely"></block>' + //AJouté par Driss
...
//AJouté par Driss
'	 <block type="text_explode"></block>' + 
//'	   <!--block type="text_getSubstring"></block Need to update block -->' +
