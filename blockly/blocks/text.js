...
Blockly.Blocks['text_explode'] = {
  ...
  init: function() {
    this.appendValueInput("NB")
        ...
        .appendField(Blockly.Msg.TEXT_EXPLODE_TITLE_1);
    this.appendValueInput("CHAINE")
        .setCheck("String")
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField(Blockly.Msg.TEXT_EXPLODE_TITLE_2);
    this.appendValueInput("SEPARATEUR")
        .setCheck("String")
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField(Blockly.Msg.TEXT_EXPLODE_TITLE_3);
    this.setInputsInline(true);
    this.setOutput(true, null);
    this.setColour(Blockly.Blocks.texts.HUE);
    this.setTooltip(Blockly.Msg.TEXT_EXPLODE_TOOLTIP);
    this.setHelpUrl(Blockly.Msg.TEXT_EXPLODE_HELPURL);
  }
