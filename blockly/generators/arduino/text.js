...
/*Ajouté par Driss */
/*pour le bloc explode */
Blockly.Arduino['text_explode'] = function(block) {
  code = "";
  return code;
/*
  var argument0 = Blockly.Arduino.valueToCode(block, 'NB',Blockly.Arduino.ORDER_UNARY_POSTFIX);
  var argument1 = Blockly.Arduino.valueToCode(block, 'CHAINE',Blockly.Arduino.ORDER_UNARY_POSTFIX);
  var argument2 = Blockly.Arduino.valueToCode(block, 'SEPARATEUR',Blockly.Arduino.ORDER_UNARY_POSTFIX);
  var myreg = new RegExp('["]', 'gi');
  argument2=argument2.replace(myreg,"\'"); 
  var func = [
      'String ' + Blockly.Arduino.DEF_FUNC_NAME + '(int index,String data, char separator) {',
      '   index--;',
      '   int found = 0;',
      '   int strIndex[] = { 0, -1 };',
  ...
  var funcName = Blockly.Arduino.addFunction('text_explode', func.join('\n'));
  //Blockly.Arduino.addInclude('--', '#include <--.h>');
  code = funcName + '(' + argument0 + ','+argument1+','+argument2 + ')';
  return [code, Blockly.Arduino.ORDER_UNARY_POSTFIX];
...
/*
var func = "String " + Blockly.Arduino.DEF_FUNC_NAME + " (int index,String data, char separator) {\n"+
  "  index--;\n"+
  "  int found = 0;\n"+
  "  int strIndex[] = { 0, -1 };\n"+
  "  int maxIndex = data.length() - 1;\n"+
  ...
  var funcName = Blockly.Arduino.addFunction('text_explode', func);
  code = funcName + '(' + argument0 + ','+argument1+','+argument2 + ')';
  return [code, Blockly.Arduino.ORDER_UNARY_POSTFIX];
...
*/
 ...
 /*   
  Blockly.Arduino.definitions_['define_explode_text'] = "String text_explode(int index,String data, char separator) {\n"+
  "  index--;\n"+
  "  int found = 0;\n"+
  "  int strIndex[] = { 0, -1 };\n"+
  "  int maxIndex = data.length() - 1;\n"+
